        ...
        <div className="flex items-center justify-between px-8 py-6">
          ...
          <div className="flex items-center gap-6">
            <div className="bg-yellow-400 rounded-full p-4">
              <svg className="w-10 h-10 text-[#1e3a5f]" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
              <div className="flex items-baseline gap-2">
                <span className="text-yellow-400 text-5xl font-bold">BIG SALE</span>
          ...
          <div className="text-right">
            ...
            <Link
              to="/shop"
              className="inline-block bg-yellow-400 hover:bg-yellow-500 text-[#1e3a5f] px-8 py-3 rounded-lg font-bold text-lg transition-colors duration-200 shadow-lg"
            >
              Shop Now
            </Link>
          </div>
