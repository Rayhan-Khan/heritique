import{r as m,_ as y,C as T,m as D,E as z,y as P,F as Ie,z as S,l as ke,A as ve,B as Se,D as Ae,d as Y}from"./firebase-app-B1z-9yCv.js";const X="@firebase/installations",R="0.6.17";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ze({appConfig:e,heartbeatServiceProvider:t},n){const o=Ye(e,n),i=De(e,n),r=t.getImmediate({optional:!0});if(r){const u=await r.getHeartbeatsHeader();u&&i.append("x-firebase-client",u)}const a={installation:{sdkVersion:Z,appId:e.appId}},c={method:"POST",headers:i,body:JSON.stringify(a)},f=await ae(()=>fetch(o,c));if(f.ok){const u=await f.json();return oe(u)}else throw await ie("Generate Auth Token",f)}function Ye(e,{fid:t}){return`${ne(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ft="/firebase-messaging-sw.js",pt="/firebase-cloud-messaging-push-scope",we="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",lt="https://fcmregistrations.googleapis.com/v1",he="google.c.a.c_id",gt="google.c.a.c_l",wt="google.c.a.ts",ht="google.c.a.e",B=1e4;var V;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(V||(V={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bt(e,t){t?e.vapidKey=t:e.vapidKey||(e.vapidKey=we)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Te(e,t){if(!navigator)throw d.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw d.create("permission-blocked");return await Bt(e,t==null?void 0:t.vapidKey),await xt(e,t==null?void 0:t.serviceWorkerRegistration),Ct(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wt(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===h.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(U(n)):e.onMessageHandler.next(U(n)));const o=n.data;Ft(o)&&o[ht]==="1"&&await Vt(e,n.messageType,o)}const G="@firebase/messaging",J="0.12.21";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xt(e=ke()){return zt().then(t=>{if(!t)throw d.create("unsupported-browser")},t=>{throw d.create("indexed-db-unsupported")}),D(Y(e),"messaging").getImmediate()}async function Qt(e,t){return e=Y(e),Te(e,t)}Jt();export{Qt as a,Xt as g,zt as i};
//# sourceMappingURL=firebase-messaging-CmJljUqo.js.map
